...
static vector<Field_Data> encyclopedia_field = {
  {"古き妖精の森", {"生い茂る草木", {Item_Number("土いも"), Item_Number(""), Item_Number(""), Item_Number(""), Item_Number(""), Item_Number("")}}, {Mob_Number(""), Mob_Number(""), Mob_Number(""), Mob_Number(""), Mob_Number(""), Mob_Number("")}, {}},
...
static vector<Item_Recipe> item_recipe = {
  ...
  {Create_Item("緊急退避バッグ", 1, {1}), {Create_Material("布", 2, {}), Create_Material("糸素材", 2, {}), Create_Material("神秘の力", 1, {})}},
...
void viewinItem_Recipe(Item_Recipe item_recipe){
  ...
  cout << "//" << endl;
  for(auto itr = item_recipe.items_list.begin(); itr != item_recipe.items_list.end(); itr++){
    cout << "//  ・[" << itr->name << "] × " << itr->quantity << endl;
  }
  cout << "//" << endl;
  cout << "/////////////////////////////////" << endl;
}
    ...
    while(!isfull_choice){
      ...
      for(auto itr = current_choices.begin(); itr != current_choices.end(); itr++){
        ...
        if(itr->size() == 0){
          ...
          for(auto itr2 = itr->begin(); itr2 != itr->end(); itr2++){
            cout << "//    ・[" << encyclopedia[itr2->number].name << "]" << endl;
          }
        }
        i++;
      }
